...
namespace Console1
{
    class Program
    {
        ...
        private static void UpdateTest(CarManager carManager, BrandManager brandManager, ColorManager colorManager)
        {
            ...
            carManager.Update(new Car { Id = 2, BrandId = 2, ColorId = 5, ModelYear = 2016, DailyPrice = 550, Descriptions = "Ford ecosport" });
            brandManager.Update(new Brand { BrandId = 2, BrandName = "Ford" });
            colorManager.Update(new Color { ColorId = 3, ColorName = "Yellow" });
        }
